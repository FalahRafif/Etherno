...
namespace App\Http\Requests\Admin\PaymentDateRule;

use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

class StorePaymentDateRuleRequest extends FormRequest
{
        ...
        return [
            'code' => [
                ...
                Rule::unique('settings', 'code')->where(function ($query): void {
                    $query->where('group_id', 'paymet_date_rule')->where('delete_status', false);
                }),
            ],
