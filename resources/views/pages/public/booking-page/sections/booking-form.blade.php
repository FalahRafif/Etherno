<section class="section-block container booking-section" id="booking">
  <div class="section-heading booking-heading">
    <p class="eyebrow">Form Pemesanan</p>
    <h2>Cek tanggal tersedia dan kirim request booking</h2>
    <p class="section-lead">Preview ini menampilkan alur awal pemesanan: cek slot, kirim detail acara, lalu tunggu approval admin sebelum pembayaran DP.</p>
  </div>
