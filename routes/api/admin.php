...
Route::prefix('admin')
    ...
    ->group(function (): void {
        ...
        Route::post('/bookings/{booking}/approve-fm-reschedule', [BookingDetailController::class, 'approveForceMajeureReschedule'])->name('bookings.approve-fm-reschedule');
        Route::post('/bookings/{booking}/approve-fm-refund', [BookingDetailController::class, 'approveForceMajeureRefund'])->name('bookings.approve-fm-refund');
        Route::post('/bookings/{booking}/reject-force-majeure', [BookingDetailController::class, 'rejectForceMajeure'])->name('bookings.reject-force-majeure');
